...
> 如果你主要在 GitHub 网页端阅读，从这里开始。你不需要先 clone 仓库，也不需要先运行 Python。

## 怎么用这个目录

1. 从第 1 篇开始点进去；
2. 每篇先看“核心结论”，不用急着理解所有细节；
3. 读到末尾后，用“上一篇 / 回目录 / 下一篇”继续导航；
4. 如果术语卡住，先回到 [`notes/glossary.md`](../notes/glossary.md)。
...
👉 [从第 1 篇：需求对齐 开始](requirements_alignment.md)
